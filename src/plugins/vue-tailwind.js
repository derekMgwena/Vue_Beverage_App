const VueTailwindSettings = {
  ...
  TButton: {
    fixedClasses: 'block px-4 py-2 transition duration-100 ease-in-out focus:border-blue-500 focus:outline-none focus:ring-opacity-50',
  ...
  TModal: {
    fixedClasses: {
      ...
      wrapper: 'w-100 relative mx-auto z-50 max-w-lg px-3 py-12 min-h-screen',
